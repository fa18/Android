...
//vue
public class ListeCourseAdaptater extends ArrayAdapter<Prods> {

    //prods est la liste des models à afficher
    public ListeCourseAdaptater(Context context, List<Prods> prods) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_liste_course,parent, false);
        }
